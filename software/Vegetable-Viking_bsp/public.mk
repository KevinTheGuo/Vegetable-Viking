...
# setting SOPC_SYSID_BASE_ADDRESS is 0x188
SOPC_SYSID_FLAG += --sidp=0x188
ELF_PATCH_FLAG  += --sidp 0x188

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1480546884
SOPC_SYSID_FLAG += --timestamp=1480546884
ELF_PATCH_FLAG  += --timestamp 1480546884
